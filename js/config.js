...
define({
    ...
    apiStorageKey : 			"apikey",
    oldBookmarkDaysKey : 		"old_archive",
    autoSortActiveKey : 		"auto_on",
    autoSortCreateKey : 		"on_create",
    autoSortTimedKey : 			"timed",
    autoSortPriorityKey : 		"priority",
    maxTaxonomyFoldersKey:      "max_taxonomy_levels",
    isOnCullBookmarks:          "cull_on",
    cullNumber:                 "cull_folder_num",
    outputMode : 				"json",
